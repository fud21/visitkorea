...
import { fetchRegion } from "../api/tourismApi";
import { useApiResource } from "../hooks/useApiResource";

export default function RegionPage() {
  const navigate = useNavigate();
  const { regionId } = useParams();
  const resource = useApiResource(() => fetchRegion(regionId), [regionId], regionDetail);
  const region = resource.usingFallback ? regionDetail : {
    ...regionDetail,
    name: resource.data.name,
    province: resource.data.provinceName || regionDetail.province,
    visitorRatio: resource.data.visitorRatio,
  };
